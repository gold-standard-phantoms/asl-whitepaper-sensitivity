...
def test_load_asl_bids_filter_mock_data(test_data):
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        assert load_bids_filter.outputs["m0"].metadata["RepetitionTime"] == [10.0]
        numpy.testing.assert_array_equal(
        ...
        assert load_bids_filter.outputs["control"].metadata["RepetitionTime"] == [
            5.0,
            5.0,
            5.0,
            5.0,
        ...
        assert load_bids_filter.outputs["label"].metadata["RepetitionTime"] == [
            5.0,
            5.0,
            5.0,
            5.0,
